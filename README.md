...
Recommend using https://modrinth.com/datapack/no-more-deepslate or a similar datapack to remove deepslate, as the default Viaversion mapping for it is garbage. If you use other datapacks along side this, you must set "ore-veins-enabled" to false in the overworld.json noise settings of each to completely remove copper ore if you desire to do so.
